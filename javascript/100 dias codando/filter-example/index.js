...
const titlePL = frontBeginners.filter(person => person.age >= 30 && person.title === "PL")

const titleJRName = frontBeginners.filter(person => person.age >= 30 && person.title === "JR").map(item => item.name)

const titleSome = frontBeginners.filter(person => person.age >= 30 && person.title === "JR").map(item => item.name).some(name => name == 'Vitinho o pequeno')

console.log(evenNumbers)
console.log(titlePL)
console.log(titleJRName)
console.log(titleSome)
console.log(number)